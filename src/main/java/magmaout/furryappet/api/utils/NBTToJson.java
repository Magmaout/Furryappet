...
public class NBTToJson {
    ...
    public static StringBuilder toJson(NBTBase base, StringBuilder builder, String indent) {
        if (base instanceof NBTTagList) {
            ...
            for (int i = 0; i < list.tagCount(); i++) {
                ...
                if (i < list.tagCount() - 1) builder.append(",");
            ...
            for (String key : tag.getKeySet()) {
                ...
                if (i < tag.getSize() - 1) builder.append(",");
            ...
            builder.append(indent);
            builder.append("}");
        } else builder.append(base.toString());
        return builder;
    }
    ...
    public static void write(File file, NBTTagCompound tag) throws IOException {
        FileUtils.writeStringToFile(file, NBTToJson.toJson(tag), StandardCharsets.UTF_8);
    }
    ...
    public static NBTTagCompound read(File file) throws IOException {
        ...
        return NBTToJson.fromJson(json);
    }
}